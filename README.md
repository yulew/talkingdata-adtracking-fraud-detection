...
These three engineered features better represent timestamp feature. After that, the features "click_time", "attributed_time" ("yyyy-mm-dd hh:mm:ss") and "hour" can be removed (if we later put them in the random forests or gradient boost to train). 
## Technical Parts
